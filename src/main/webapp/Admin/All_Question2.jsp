...
<title>All Question(Java)</title>
	<style>
    	body{
            ...
            background: linear-gradient(to top,#021024,#052659,#5483B3,#C1EB8FF);
...
<div class="container">
	<%
        ...
        <h2><button><a href="../Admin/All_question_choice.jsp">Back</a></button>All Questions(Java)</h2>
                    <table border="1">
         ...
         <%
               Statement stmt=con.createStatement();
         	   ResultSet rs=stmt.executeQuery("select * from Question2");
         	   while(rs.next()){
         		    %>
