...
<div class="container">
	<%
        ...
        <h2><button><a href="../Admin/All_question_choice.jsp">Back</a></button>All Student Results(C++)</h2>
                    <table border="1">
         ...
         <%
               Statement stmt=con.createStatement();
         	   ResultSet rs=stmt.executeQuery("select * from Result1");
         	   while(rs.next()){
         		    %>
         		     ...
         		     <tr>
		                    ...
		                    <td><a href="Delete_Result1.jsp?roll=<%=rs.getString("RollNo") %>" onclick="return confirm('Are you sure Do you want to delete?');">
