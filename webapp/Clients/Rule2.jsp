...
<body>
 <div id="rule">
 <form action="../Clients/Quize2.jsp" method="post">
      <div>  
    ...
    <img src="../images/r1.png" height="60px" width="55px" style="margin-left:2rem;position:absolute;top:290px;">
       <p style="margin-top: 9rem;margin-left: 6rem;position: absolute;">Must Fill Carefully In The Registration<br> Form.</p>
        <img src="../images/i5.png" height="50px" width="50px" style="margin-top: 7rem;margin-left: 23rem;position: absolute;top:180px;"><p style="margin-top: 9rem;margin-left: 26rem;position: absolute;">Avoid Seeking Solutions Asking<br> External Questions.</p>
    </div>
