...
<body>
   <form action="../Clients/Quize2_process.jsp" method="post">
    <h2>Quiz</h2>
        <% 
        ...
        String password="root";
            ...
            try {
            	...
            	String sql="SELECT Question, Option1, Option2, Option3, Option4, Answer FROM Question2 ORDER BY RAND() LIMIT 10";
